...
import com.doubanapp.hbj.douban.mtprovider.ContentViewPagerProvider;
...
public class MovieFragment extends LazyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.register(ContentViewPagerItem.class, new ContentViewPagerProvider(mContext));
        ...
        items.add(new ContentViewPagerItem(mData5));
