...
public class HomeAllFragment extends BaseFragment implements IHomeAllFragmentView {
    ...
    protected View initChildView() {
        ...
        homeAllFragmentPresenter.doInitBottomSheet(mContext.getBottomsheet());
    ...
    protected synchronized void lazyLoad() {
        ...
        homeAllFragmentPresenter.doConnectHttp(MyConstants.HOME_ALL_PRESENTER_PAGE_INDEX, false,false);
    }
