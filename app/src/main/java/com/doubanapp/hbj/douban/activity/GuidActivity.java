...
import com.doubanapp.hbj.douban.presenter.GuidPresenter;
...
* 设置向导界面
* */
public class GuidActivity extends AppCompatActivity implements CheckBox.OnCheckedChangeListener, View.OnClickListener, IGuidView {
    ...
    private GuidPresenter guidPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //presenter
        guidPresenter = new GuidPresenter(this);
        guidPresenter.doGetWidth(this);
        guidPresenter.doAnim();
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        //改变进入主界面按钮状态
        guidPresenter.doChangeStartHomeState();
    ...
    * */
    ...
    @Override
    public void onInitAnim(TranslateAnimation forwardTranslateAnimation, TranslateAnimation reverseTranslateAnimation) {
    ...
    @Override
    public void onChangeStartHomeState() {
        if (checkedCount >= 1) {
