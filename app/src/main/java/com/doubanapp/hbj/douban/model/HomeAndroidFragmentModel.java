 ...
 */
public class HomeAndroidFragmentModel {

    private static final String TAG = "HomeAndroidFragmentModel";
    private Context mContext;
    private IHomeAndroidModel iHomeAndroidModel;
    private List<String> mData = new ArrayList<>();
    private Subscription subscription;

    public HomeAndroidFragmentModel(Context mContext, IHomeAndroidModel iHomeAndroidModel) {
        this.mContext = mContext;
        this.iHomeAndroidModel = iHomeAndroidModel;
    }
        ...
        subscription = retrofit.create(MyServiceInterface.class).toSearch("yuantong", "500379523313")
                ...
                .subscribe(new Subscriber<KuaiDiJsonData>() {
                    ...
                    public void onCompleted() {
                        //请求结束
                        iHomeAndroidModel.onConnectCompleted();
                    }

                    @Override
                    public void onError(Throwable e) {
                        //错误回调
                        iHomeAndroidModel.onConnectError();
                    }
                    ...
                    public void onNext(KuaiDiJsonData res) {
                        ...
                        iHomeAndroidModel.onHomeAndroidConnectNext(mData);
                    }
                    ...
                    public void onStart() {
                        ...
                        iHomeAndroidModel.onConnectStart(false,false);
                    }
                });
    }
