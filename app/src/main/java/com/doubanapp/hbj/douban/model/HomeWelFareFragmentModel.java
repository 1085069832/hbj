 ...
 */
public class HomeWelFareFragmentModel {

    private static final String TAG = "HomeWelFareFragmentModel";
    private Context mContext;
    private IHomeWelFareModel iHomeWelFareModel;
    private Subscription subscription;
    private List<String> mData = new ArrayList<>();

    public HomeWelFareFragmentModel(Context mContext, IHomeWelFareModel iHomeWelFareModel) {
        this.mContext = mContext;
        this.iHomeWelFareModel = iHomeWelFareModel;
    }
        ...
        subscription = retrofit.create(MyServiceInterface.class).toSearch("yuantong", "500379523313")
                ...
                .subscribe(new Subscriber<KuaiDiJsonData>() {
                    ...
                    public void onCompleted() {
                        //请求结束
                        iHomeWelFareModel.onConnectCompleted();
                    }

                    @Override
                    public void onError(Throwable e) {
                        //错误回调
                        iHomeWelFareModel.onConnectError();
                    }
                    ...
                    public void onNext(KuaiDiJsonData res) {
                        ...
                        iHomeWelFareModel.onHomeWelFareConnectNext(mData);
                    }

                    @Override
                    public void onStart() {
                        //开始
                        iHomeWelFareModel.onConnectStart(false,false);
                    }
                });
    }
